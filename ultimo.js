...
let mostrarResultado = document.getElementById("muestroPaletas")



//creo un array vacio para agregar los objetos que creo
let listaPaletas = []
...
let mostrarPaletas = () =>{
    ...
    listaPaletas.forEach(function(elemento){
        mostrarResultado.innerHTML += `Nombre: ${elemento.nombrePaleta}, Sabor: ${elemento.saborPaleta}, Precio: ${elemento.precioPaleta}, Cantidad en stock: ${elemento.stockPaleta}<br/>`
    })
